...
Through the benchmarking process, we have established the proposed system is very scalable. If there are bottlenecks, we can easily increase the number of instances to handle the load, or allow a cluster of servers working together to distribute the load. That means, the proposed system is capable of handling much more demanding loads given that enough computational resources are provided. 
